...
module.exports ={
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subCommand=> subCommand.setName("song").setDescription("Lädt ein einzelnes Lied mit der Url").addStringOption(option => option.setName("url").setDescription("DIE URL").setRequired(true)))
    ...
    async execute(interaction,client) {
        ...
        if(!interaction.member.voice.channel){
            interaction.editReply("Komm sofort in den Sprachkanal")
            return;
        }
